        ...
        <div>
            <footer className="footer md:footer-horizontal bg-orange-200 text-black p-10">
                <aside>
                    ...
                    <p className='text-xs'>A Reliable Ally in finding lost items</p>
                </aside>
                <nav>
                    <h6 className="footer-title">Services</h6>
                    <a className="link link-hover">Lost</a>
                    <a className="link link-hover">Report Lost</a>
                    <a className="link link-hover">Found</a>
                ...
                <nav>
                    ...
                    <a className="link link-hover">Tel: + 13 987900000</a>
