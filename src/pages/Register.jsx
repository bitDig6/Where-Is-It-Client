...
const Register = () => {
    ...
    const handleRegister = (e) => {
        ...
        const photo = registrationData.photo;
            ...
            <div className="hero-content flex-col lg:flex-row-reverse">
                ...
                <div className="card w-full max-w-sm shrink-0 shadow-2xl">
                    <div className="card-body">
                        ...
                        <p className='mt-4'>Already have an Account? <Link to='/login' className='text-blue-600 hover:underline hover:underline-offset-4'>Login</Link> from here</p>
